...
import 'package:fabverse/adminpanel/bookmodel.dart';
import 'package:fabverse/adminpanel/bookdetail.dart';

class ManageBooksPage extends StatefulWidget {
  const ManageBooksPage({Key? key}) : super(key: key);
...
class AdBottomBar extends StatelessWidget {
  const AdBottomBar({Key? key}) : super(key: key);
